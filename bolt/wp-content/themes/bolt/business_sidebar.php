<div class="homepage" id="subrightcol">
      <div id="quoteboxsm">
        <form action="https://www.boltinsurance.com/insurance-quotes">
          <p class="smtxt">Get <span class="orange">Instant Quotes</span> For</p>
          
          <!--change text to either Homeowners Insurance or Auto Insurance depending on page -->
          <p class="insurancetype">Business Insurance</p>
